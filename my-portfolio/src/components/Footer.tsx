          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-400">{resumeData.email}</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-400">{resumeData.phone}</span>
              </div>
